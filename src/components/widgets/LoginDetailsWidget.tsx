...
import { Box, Button, ButtonGroup, FormGroup, Paper, styled, TextField, Typography } from '@mui/material';
import { Formik } from 'formik';
import React from 'react';

export interface LoginDetailsFormValues {
  email: string;
  password: string;
}
...
export interface LoginDetailsWidgetProps {
  title: string;
